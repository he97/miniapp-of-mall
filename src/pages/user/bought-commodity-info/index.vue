...
<!-- 写个分割线 -->
    ...
    <div>
      <van-cell-group>
        ...
        <van-cell title="品类名" :value="categoryName" />
        <van-cell title="交易id" :value="transactionId" />
        <van-cell title="您的手机号" :value="phone" />
        <van-cell title="您的地址" :value="address" />
        <van-cell title="你的备注" :value="transactionInfo" />
        <van-cell title="交易时间" :value="time" />
...
import {GET_BOUGHT_INFO, ADD_CART} from '@/utils/api'
export default {
  data () {
    return {
      shop_title: '商店标签',
  ...
  methods: {
    ...
    async fetchSharePosts (init) {
      ...
      this.pics = urls
      this.address = commodity.transactionAddress
      this.transactionId = commodity.transactionId
      this.phone = commodity.transactionPhone
      this.time = commodity.transactionTime
      this.transactionInfo = commodity.transactionInfo
